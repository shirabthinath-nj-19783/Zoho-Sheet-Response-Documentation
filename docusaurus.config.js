    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            { label: 'Blog', to: '/blog' },
            { label: 'GitHub', href: 'https://github.com/shirabthinath-nj-19783/Zoho-Sheet-Response-Documentation' },
          ],
        },
      ],
      copyright: `Copyright © ${new Date().getFullYear()} Zoho Sheet. Built with Docusaurus.`,
    },
    prism: {
